...
class InvestorsControllerTest < ActionController::TestCase
  ...
  test "should create investor" do
    assert_difference('Investor.count') do
      post :create, investor: { first_name: @investor.first_name, id: @investor.id, last_name: @investor.last_name, phone_number: @investor.phone_number }
    end
  ...
  test "should update investor" do
    patch :update, id: @investor, investor: { first_name: @investor.first_name, id: @investor.id, last_name: @investor.last_name, phone_number: @investor.phone_number }
    assert_redirected_to investor_path(assigns(:investor))
  end
